...
Yelp holds contests for students and the public in which the company releases a large amount of data and particpants compete to reach one of a few specialized goals, ranging from building social network graphs to creating image recognition models. Our project uses this data to tackle our own question: Can we predict whether a restaurant has a good rating (four or five stars) or a bad rating (one, two or three stars)?
